...
import frc.robot.commands.auto.vision.LimeShot;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(RobotContainer.joyD, 6)
        .toggleWhenActive(new ShooterCommand(this.shooterSubsystem, 2590));
    ...
    new JoystickButton(RobotContainer.joyD, 10)
        .whenPressed(
          new LimeDance(shooterSubsystem, feederSubsystem, driveSubsystem));
  ...
  public Command getAutonomousCommand() {
    ...
    //return new GoalAlignCommand(driveSubsystem);
    // return new LimeShot(shooterSubsystem, feederSubsystem, driveSubsystem);
    return new AutonomousRoutineCommand(shooterSubsystem, feederSubsystem, driveSubsystem, intakeSubsystem, intakeStarterSubsystem);
  }
