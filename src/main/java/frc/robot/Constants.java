...
public final class Constants {
    public final static class DrivingConstants {
        public static final double sexyMaxSpeed = 0.9;
    ...
    public final static class ShooterConstants {
        ...
        public static final double kI = 0;// 3e-8;
        public static final double kD = 1.2;
    ...
    public final static class ClimberConstants {
        ...
        public final static class PGConstants {
            ...
            public static final int innerPGConstants = 14;
            public static final int outerPGConstants = 15;
            public static final double speedMultiplier = 0.8;
            public static final double kPInner = 0.145;
            public static final double kIInner = 0;
            public static final double kDInner = 0;
            public static final double kPOuter = 0.145;
